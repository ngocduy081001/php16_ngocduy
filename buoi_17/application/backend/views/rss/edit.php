...
<body style="background-color: #eee;">
    <div class="container pt-5">
        <form action="index.php?module=backend&controller=rss&action=update" method="post">
            <div class="card">
              ...
              ';
                ...
                <div class="card-footer">
                    ...
                    <a href="ndex.php?module=backend&controller=rss&action=index" class="btn btn-danger">Cancel</a>
                </div>
            </div>
        </form>
    </div>
