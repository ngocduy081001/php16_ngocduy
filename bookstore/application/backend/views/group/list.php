    ...
    foreach ($data as $key => $value) {
        ...
        <td class="text-center">
            <div class="custom-control custom-checkbox">
                <input class="custom-control-input" type="checkbox" id="checkbox-1" name="checkbox[]"
                 value="' . $value['id'] . '">
        ...
        <td class="text-center position-relative"> ' . Helpers::itemStatus($value['status'], $value['id']) . '</td>

        
        <td class="text-center position-relative"> ' . Helpers::itemGroup($value['group_acp'], $value['id']) . '</td>
